...
def get_fast_scnn(model_loc, map_cpu=False, **kwargs):
...
def resize_image_matrix(image, target_height, target_width):
    """
    Resize an image matrix using OpenCV.
    ...
    return Image.fromarray(resized),[H,W]
